...
namespace CanvasDrawer.Graphics {
    public class Graphics2D {
        ...
        public void DrawText(double x, double y, string text) {
            if (GoodString(text)) {
                PageManager pageManager = GraphicsManager.Instance.PageManager;
                pageManager.DrawText(x, y, text, FontSize, FontFamily, TextColor, FontAlign);
            }
        }
        ...
        public double TextWidth(string text) {
            if (GoodString(text)) {
                PageManager pageManager = GraphicsManager.Instance.PageManager;
                return pageManager.TextWidth(text, FontFamily, FontSize);
            }
            return 0;
        }
        ...
        public void DrawRect(double x, double y, double width, double height) {
            ...
            if (GoodRect(x, y, width, height)) {
                PageManager pageManager = GraphicsManager.Instance.PageManager;
                double dashLength = (LineStyle == ELineStyle.SOLID) ? 0 : 5;
                pageManager.DrawRect(x, y, width, height, FillColor, LineColor, LineWidth, dashLength);
            }
        }

        public void DrawEllipse(double xc, double yc, double radx, double rady) {
            PageManager pageManager = GraphicsManager.Instance.PageManager;
            pageManager.DrawEllipse(xc, yc, radx, rady, FillColor, LineColor, LineWidth);
        }
            ...
            pageManager.DrawArc(x, y, rad, startAngle, endAngle, FillColor, LineColor, LineWidth, dashLength);
        }
        ...
        public void DrawImage(double x, double y, double width, double height, string imageId) {
            if (GoodRect(x, y, width, height) && GoodString(imageId)) {
                PageManager pageManager = GraphicsManager.Instance.PageManager;
                pageManager.DrawImage(x, y, width, height, imageId);
            }
        }
        ...
        public void DrawRotatedImage(double x, double y, double width, double height, double angle, string imageId) {
            if (GoodRect(x, y, width, height) && GoodString(imageId)) {
                PageManager pageManager = GraphicsManager.Instance.PageManager;
                pageManager.DrawRotatedImage(x, y, width, height, angle, imageId);
            }
        }
        ...
        public void DrawLine(double x1, double y1, double x2, double y2) {
            PageManager pageManager = GraphicsManager.Instance.PageManager;
            double dashLength = (LineStyle == ELineStyle.SOLID) ? 0 : 5;
            pageManager.DrawLine(x1, y1, x2, y2, LineColor, LineWidth, dashLength);
        }
